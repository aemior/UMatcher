...
void printUsage(const char* program_name) {
    std::cout << "Usage: " << program_name << " [options]\n"
              << "Options:\n"
              << "  --template_branch PATH   Path to template branch (default: ../data/template_branch)\n"
              << "  --search_branch PATH     Path to search branch (default: ../data/search_branch)\n"
...
int main(int argc, char* argv[]) {
    // Default parameters
    std::string template_branch = "../data/umatcher_ncnn/template_branch.ncnn";
    std::string search_branch = "../data/umatcher_ncnn/search_branch.ncnn";
    ...
    // Prepare model paths
    std::string param_template = template_branch + ".param";
    std::string bin_template = template_branch + ".bin";
    std::string param_search = search_branch + ".param";
    std::string bin_search = search_branch + ".bin";

    // Initialize UTracker
    UTracker tracker(param_template.c_str(), bin_template.c_str(),
                    param_search.c_str(), bin_search.c_str(),
